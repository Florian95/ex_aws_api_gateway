defmodule ExAws.ApiGateway do
  ...
  @doc "Gets the ApiKeys resource representing the set of ApiKey resources to identify clients for all of your APIs."
  @spec get_apis_keys() :: ExAws.Operation.JSON.t()
  def get_apis_keys() do
    request(:get, :api_key, "/apikeys?includeValues=true")
  end

  @doc "Gets the ApiKey resource with the specified key identifier."
  @spec get_api_key(keyId :: binary) :: ExAws.Operation.JSON.t()
  def get_api_key(keyId) do
    request(:get, :api_key, "/apikeys/#{keyId}?includeValue=true")
  end

  @doc "Gets the RestApis resource representing the collection of RestApi resources for all of your APIs."
  @spec get_rest_apis() :: ExAws.Operation.JSON.t()
  def get_rest_apis() do
    request(:get, :rest_api, "/restapis")
  end

  @doc "Gets the UsagePlans resource as the collection of UsagePlan resources of the caller's account."
  ...
  @doc "Disassociate an existing API key to the specified usage plan"
